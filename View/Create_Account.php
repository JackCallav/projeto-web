...
<body>
    <div class="w3-third w3-display-middle w3-card-4" style="width: 35vw; height: 50vh;">
        ...
        <div class="w3-container">
            <form method="POST" action="Call_Create_Account.php">
                ...
                <input class="w3-button w3-border w3-teal w3-third w3-display-bottommiddle" type="submit" value="Registrar" style="bottom: 3vh;"/>
            </form>
        </div>
    </div>
</body>
