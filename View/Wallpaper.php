...
<div class="w3-third w3-card-4" style="height: 100vh; position: fixed;">
    ...
    <div class="w3-display-container w3-twothird w3-right">
        <div class="w3-container w3-teal" style="width: 100%; height: 6vh;">
            <h2 style="font-family: arial; font-size: 3vh; letter-spacing: 0.5vw;"> WALLPAPER </h2>
        </div>
        <div class="w3-container" style="position: relative; top: 1vh;">
            <div class="w3-container cont w3-third" style="width: 30vw;">
                <form method="POST" action="Call_WallpaperEdit.php">
                    <input class="w3-small w3-button w3-border w3-teal w3-hover-light-gray" type="submit" value="Usar" style="position: relative; z-index: +1;"/>
                    <input type="hidden" name="Wallpaper" value="Wallpaper"/>
                    <img class="Imgs" src="Template Images/Wallpaper.jpg"/>
                </form>  
            </div>
            <div class="w3-container cont w3-third" style="width: 30vw;">
                <form method="POST" action="Call_WallpaperEdit.php">
                    <input class="w3-small w3-button w3-border w3-teal w3-hover-light-gray" type="submit" value="Usar" style="position: relative; z-index: +1;"/>
                    <input type="hidden" name="Wallpaper" value="Girl"/>
                    <img class="Imgs" src="Template Images/Girl.jpg"/>
                </form>  
            </div>
        </div>
    </div>
